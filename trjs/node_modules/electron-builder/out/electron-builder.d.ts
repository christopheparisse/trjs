...
declare module "electron-builder/out/util/httpRequest" {
  import { DownloadOptions } from "electron-builder/out/util/httpExecutor"
...
declare module "electron-builder/out/util/nodeHttpExecutor" {
  /// <reference types="node" />
  import { ClientRequest } from "http"
  import { HttpExecutor, DownloadOptions } from "electron-builder/out/util/httpExecutor"
  import { Url } from "url"
...
declare module "electron-builder/out/publish/bintray" {
  ...
  export { HttpError, request } from "electron-builder/out/util/httpExecutor"
