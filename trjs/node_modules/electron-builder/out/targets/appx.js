    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            yield (_bluebirdLstC2 || _load_bluebirdLstC2()).default.all([(_bluebirdLstC2 || _load_bluebirdLstC2()).default.map(["44x44", "50x50", "150x150", "310x150"], function (size) {
                ...
                return (0, (_fsExtraP || _load_fsExtraP()).copy)(_path.join(templatePath, "assets", `SampleAppx.${ size }.png`), target);
            ...
            yield (0, (_util || _load_util()).spawn)(_path.join((yield (0, (_windowsCodeSign || _load_windowsCodeSign()).getSignVendorPath)()), "windows-10", arch === (_metadata || _load_metadata()).Arch.ia32 ? "ia32" : "x64", "makeappx.exe"), args);
