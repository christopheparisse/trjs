...
class SquirrelWindowsTarget extends (_targetFactory || _load_targetFactory()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            const installerOutDir = _path.join(_this.outDir, `win${ (0, (_platformPackager || _load_platformPackager()).getArchSuffix)(arch) }`);
    ...
    computeEffectiveDistOptions() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (iconUrl == null) {
                const info = yield (0, (_repositoryInfo || _load_repositoryInfo()).getRepositoryInfo)(packager.appInfo.metadata, packager.info.devMetadata);
                if (info != null) {
