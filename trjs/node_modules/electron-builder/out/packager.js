...
class Packager {
    ...
    doBuild(cleanupTasks) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            const distTasks = [];
            const outDir = _path.resolve(_this2.projectDir, (0, (_util || _load_util()).use)(_this2.devMetadata.directories, function (it) {
                return it.output;
            }) || "dist");
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (options.nodeGypRebuild === true) {
                ...
                yield (0, (_util || _load_util()).exec)(process.platform === "win32" ? "node-gyp.cmd" : "node-gyp", ["rebuild"], {
                    env: (0, (_yarn || _load_yarn()).getGypEnv)(_this3.electronVersion, (_metadata || _load_metadata()).Arch[arch], true)
                });
            }
