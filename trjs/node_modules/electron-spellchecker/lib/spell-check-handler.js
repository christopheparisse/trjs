...
var _fakeLocalStorage = require('./fake-local-storage');

var _fakeLocalStorage2 = _interopRequireDefault(_fakeLocalStorage);
...
class SpellCheckHandler {
  ...
  constructor() {
    ...
    try {
      this.localStorage = localStorage || window.localStorage || new _fakeLocalStorage2.default();
    } catch (ugh) {
      this.localStorage = new _fakeLocalStorage2.default();
    }
    ...
    if (isMac) {
      ...
      this.currentSpellchecker = new _nodeSpellchecker.Spellchecker();
  ...
  attachToInput() {
    ...
    let languageDetectionMatches = contentToCheck.mergeMap(text => {
  ...
  switchLanguage(langCode) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this3.currentSpellcheckerLanguage !== actualLang || !_this3.currentSpellchecker) {
        ...
        _this3.currentSpellchecker = new _nodeSpellchecker.Spellchecker();
  ...
  loadDictionaryForLanguageWithAlternatives(langCode) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let alternatesTable = JSON.parse(_this4.localStorage.getItem(localStorageKey) || '{}');
      ...
      if (langCode in alternatesTable) {
        try {
          ...
          _this4.localStorage.setItem(localStorageKey, '{}');
        }
      }
      ...
      return yield _Observable.Observable.of(...alternatives).concatMap(function (l) {
        return _Observable.Observable.defer(function () {
          ...
          _this4.localStorage.setItem(localStorageKey, JSON.stringify(alternatesTable));
        }).catch(function () {
  ...
  buildLikelyLocaleTable() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (process.platform === 'win32') {
        localeList = (0, _keyboardLayout.getInstalledKeyboardLanguages)();
      }
      ...
      if (process.platform === 'linux' && process.env.LANG) {
        ...
        ret[m[0].substring(0, 2)] = (0, _utility.normalizeLanguageCode)(m[0]);
      }
