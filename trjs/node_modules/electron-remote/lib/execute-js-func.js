...
let evalRemoteMethod = (() => {
  ...
  return function evalRemoteMethod(_x4, _x5) {
...
const BrowserWindow = isBrowser ? require('electron').BrowserWindow : require('electron').remote.BrowserWindow;
...
function getSendMethod(windowOrWebView) {
  ...
  return 'webContents' in windowOrWebView ? function () {
...
function objectAndParentGivenPath(path) {
  ...
  let listener = (() => {
    ...
    return function listener(_x6, _x7) {
