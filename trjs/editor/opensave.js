...
trjs.io = (function () {
    ...
    function setAudio() {
        ...
        $('#media-display').html('<audio id="audio-display" controls preload="auto" controls="controls">' +
    ...
    function setVideo() {
        ...
        $('#media-display').html('<video id="video-display" preload="auto" controls="controls">' +
