...
trjs.messgs_eng = {
	...
	bin49: "Set line as 1st locutor" , // Ctrl 1
	bin50: "Set line as 2nd locutor" , // Ctrl 2
	bin51: "Set line as 3rd locutor" , // Ctrl 3
	bin52: "Set line as 4th locutor" , // Ctrl 4
	bin53: "Set line as 5th locutor" , // Ctrl 5
	bin54: "Set line as 6th locutor" , // Ctrl 6
	bin55: "Set line as 7th locutor" , // Ctrl 7
	bin56: "Set line as 8th locutor" , // Ctrl 8
	bin57: "Set line as 9th locutor" , // Ctrl 9

	bin35: "Move to the end of file" , // Ctrl End
	bin36: "Move to the begining of file" , // Ctrl Home
	bin66: "Play media slower" , // Ctrl B
	bin68: "Delete current line" , // Ctrl D
	bin69: "Play media faster" , // Ctrl E
	bin71: "Insert the start of a div" , // Ctrl G
	bin73: "Insert an empty line" , // Ctrl I
	bin74: "Join the current line with the next one" , // Ctrl J
	bin76: "Go to line number" , // Ctrl L
	bin77: "Store time to end of current main line and begining of next line and jumps to next line" , // Ctrl M
	bin79: "Open a transcription" , // Ctrl O
	bin82: "Duplicate current line" , // Ctrl R
	bin83: "Save the current file" , // Ctrl S
	bin84: "Show go to time interface panel" , // Ctrl T
	bin85: "Hide the div" , // Ctrl U
//	bin88: "" , // Ctrl X
	bin89: "Redo last change" , // Ctrl Y
	bin90: "Undo last change" , // Ctrl Z

	bin49: "Set the current line as the start of a div" , // Ctrl Shift 1
	bin50: "Set the current line as the end of a div" , // Ctrl Shift 2
	bin71: "Close all currently opened divs" , // Ctrl Shift G

	bin49: "Set line as 1st template" , // Ctrl Alt 1
	bin50: "Set line as 2nd template" , // Ctrl Alt 2
	bin51: "Set line as 3rd template" , // Ctrl Alt 3
	bin52: "Set line as 4th template" , // Ctrl Alt 4
	bin53: "Set line as 5th template" , // Ctrl Alt 5
	bin54: "Set line as 6th template" , // Ctrl Alt 6
	bin55: "Set line as 7th template" , // Ctrl Alt 7
	bin56: "Set line as 8th template" , // Ctrl Alt 8
	bin57: "Set line as 9th template" , // Ctrl Alt 9

	bin65: "Select line" , // Ctrl Alt A
	bin66: "Play in reverse" , // Ctrl Alt B
	bin68: "Delete the current group of lines" , // Ctrl Alt D
	bin69: "Play at normal rate" , // Ctrl Alt E
	bin70: "Show search interface panel" , // Ctrl F
	bin71: "Insert a closing div" , // Ctrl Alt G
	bin73: "Insert a line with setting the current time" , // Ctrl Alt I
	bin74: "Join the current main line with the next main line" , // Ctrl Alt J

	bin77: "Store time to end of current line and begining of next line" , // Ctrl Alt M
	bin79: "Load a media" , // Ctrl Alt O
	bin82: "Split the line at the cursor" , // Ctrl Alt R
	bin85: "Show the hidden div" , // Ctrl Alt U

	bin113: "Set the color of the selected text to red" , // Ctrl Alt F2
	bin114: "Set the color of the selected text to green" , // Ctrl Alt F3
	bin115: "Set the color of the selected text to blue" , // Ctrl Alt F4
	bin116: "Set the format of the selected text to bold" , // Ctrl Alt F5
	bin117: "Set the format of the selected text to italics" , // Ctrl Alt F6
	bin118: "Set the format of the selected text to emphasis" , // Ctrl Alt F7
	bin119: "Set/unset multiple selection" , // Ctrl Alt F8
	bin120: "Extract selection to subtitles (srt format)" , // Ctrl Alt F9
	bin121: "Extract selection to subtitles (ass format)" , // Ctrl Alt F10
	bin122: "Extract selection to subtitles with media" , // Ctrl Alt F11
	bin123: "Extract selection to media" , // Ctrl Alt F12

	bin37: "Jump backwards a little bit" , // Alt Left
	bin38: "Go up to the next main line" , // Alt Up
	bin39: "Jump forwards a little bit" , // Alt Right
	bin40: "Go down to the next main line" , // Alt Down
	bin112: "Play from the current position in the transcription" , // Alt F1
	bin113: "Reduce the size of the media" , // Alt F2
	bin114: "Increase the size of the media" , // Alt F3
	bin115: "Play the media two times slower" , // Alt F4
	bin116: "Play the media two times faster" , // Alt F5
	bin117: "Insert any empty line begining at the current time and with the current locutor information" , // Alt F6
	bin118: "Play three main lines around the current one" , // Alt F7
	
	bin9: "Play from the start of the current line" , // Shift Tab
	bin112: "Play from the current media time" , // Shift F1
	
//	bin114: "Specific function (trjs.keys.special1)" , // Shift F3
	bin115: "Local save in HTML format" , // Shift F4
...
trjs.messgs_fra = {
	...
	bin49: "Rappel du 1er locuteur" , // Ctrl 1
	bin50: "Rappel du 2nd locuteur" , // Ctrl 2
	bin51: "Rappel du 3ème locuteur" , // Ctrl 3
	bin52: "Rappel du 4ème locuteur" , // Ctrl 4
	bin53: "Rappel du 5ème locuteur" , // Ctrl 5
	bin54: "Rappel du 6ème locuteur" , // Ctrl 6
	bin55: "Rappel du 7ème locuteur" , // Ctrl 7
	bin56: "Rappel du 8ème locuteur" , // Ctrl 8
	bin57: "Rappel du 9ème locuteur" , // Ctrl 9

	bin35: "Aller à la fin du fichier" , // Ctrl End
	bin36: "Aller au début du fichier" , // Ctrl Home
	bin66: "Jouer le média plus lentement" , // Ctrl B
	bin68: "Supprimer la ligne courante" , // Ctrl D
	bin69: "Jouer le média plus rapidement" , // Ctrl E
	bin71: "Créer une division du texte (séquence ou saynète)" , // Ctrl G
	bin73: "Insérer une ligne vide" , // Ctrl I
	bin74: "Joindre deux lignes (ligne courante et la suivante)" , // Ctrl J
	bin76: "Aller au numéro de ligne..." , // Ctrl L
	bin77: "Marquer le temps de fin de la ligne courante principale et le temps de début de la suivante et sauter à la ligne suivante" , // Ctrl M
	bin79: "Ouvrir une transcription" , // Ctrl O
	bin82: "Dupliquer la ligne courante" , // Ctrl R
	bin83: "Sauvegarder" , // Ctrl S
	bin84: "Aller au repère temporel..." , // Ctrl T
	bin85: "Cacher les divisions du texte" , // Ctrl U
//	bin88: "" , // Ctrl X
	bin89: "Refaire la dernière modification" , // Ctrl Y
	bin90: "Annuler la dernière modification" , // Ctrl Z

	bin49: "Marquer la ligne courante comme début d'une division" , // Ctrl Shift 1
	bin50: "Marquer la ligne courante comme fin d'une division" , // Ctrl Shift 2
	bin71: "Fermer toutes les divisions ouvertes" , // Ctrl Shift G

	bin49: "Rappel de la 1ère structure" , // Ctrl Alt 1
	bin50: "Rappel de la 2ème structure" , // Ctrl Alt 2
	bin51: "Rappel de la 3ème structure" , // Ctrl Alt 3
	bin52: "Rappel de la 4ème structure" , // Ctrl Alt 4
	bin53: "Rappel de la 5ème structure" , // Ctrl Alt 5
	bin54: "Rappel de la 6ème structure" , // Ctrl Alt 6
	bin55: "Rappel de la 7ème structure" , // Ctrl Alt 7
	bin56: "Rappel de la 8ème structure" , // Ctrl Alt 8
	bin57: "Rappel de la 9ème structure" , // Ctrl Alt 9

	bin65: "Sélectionner la ligne" , // Ctrl Alt A
	bin66: "Lecture à l'envers" , // Ctrl Alt B
	bin68: "Supprimer une ligne et tous celles qui en dépendent" , // Ctrl Alt D
	bin69: "Lecture à une rythme normal" , // Ctrl Alt E
	bin70: "Faire une recherche" , // Ctrl F
	bin71: "Marquer la fin d'une division" , // Ctrl Alt G
	bin73: "Insérer une ligne vide avec le temps courant" , // Ctrl Alt I
	bin74: "Joindre la ligne courante principale avec la ligne principale suivante" , // Ctrl Alt J

	bin77: "Marquer le temps de fin de la ligne courante et le temps de début de la suivante" , // Ctrl Alt M
	bin79: "Charger un média" , // Ctrl Alt O
	bin82: "Scinder une ligne en deux (à l'endroit où se trouve le curseur) sans indication temporelle" , // Ctrl Alt R
	bin85: "Montrer les divisions cachées" , // Ctrl Alt U

	bin113: "Colorer le texte sélectionné en rouge" , // Ctrl Alt F2
	bin114: "Colorer le texte sélectionné en vert" , // Ctrl Alt F3
	bin115: "Colorer le texte sélectionné en bleu" , // Ctrl Alt F4
	bin116: "Mettre le texte sélectionné en gras" , // Ctrl Alt F5
	bin117: "Mettre le texte sélectionné en italique" , // Ctrl Alt F6
	bin118: "Mettre le texte sélectionné en petites majuscules (EM: emphasis)" , // Ctrl Alt F7
	bin119: "Afficher/cacher la sélection multiple" , // Ctrl Alt F8
	bin120: "Extraire la sélection en soustitres (format .srt)" , // Ctrl Alt F9
	bin121: "Extraire la sélection en soustitres (format .ass)" , // Ctrl Alt F10
	bin122: "Extraire la sélection en soustitres avec le média" , // Ctrl Alt F11
	bin123: "Extraire la sélection en média" , // Ctrl Alt F12

	bin37: "Revenir en arrière" , // Alt Left
	bin38: "Aller à la ligne principale précédente" , // Alt Up
	bin39: "Aller en avant" , // Alt Right
	bin40: "Aller à la ligne principale suivante" , // Alt Down
	bin112: "Lecture à partir de l'endroit où le curseur est situé, pause" , // Alt F1
	bin113: "Réduire la taille de la vidéo" , // Alt F2
	bin114: "Agrandir la taille de la vidéo" , // Alt F3
	bin115: "Jouer la vidéo moins vite" , // Alt F4
	bin116: "Jouer la vidéo plus vite" , // Alt F5
	bin117: "Insérer une ligne vide sous un locuteur en notant le temps courant" , // Alt F6
	bin118: "Jouer 3 lignes autour de la ligne courante" , // Alt F7
	
	bin9: "Lecture à partir du début de la ligne courante" , // Shift Tab
	bin112: "Lecture à partir du temps du média, pause" , // Shift F1
	
//	bin114: "specific function (trjs.keys.special1)" , // Shift F3
	bin115: "Sauvegarde locale au format HTML" , // Shift F4
...
"<p>TranscriberJS permet de réaliser des transcriptions rapidement à partir d'un média vidéo ou audio." +
...
"<p>TranscriverJS permet aussi une utilisation classique en utilisant la souris et en découpant les sons et" + 
"images au préalable ou au fur et à mesure. TranscriberJS permet aussi d'aligner un texte brut ne présentant" +
...
"sur \"Paramètres\" ou \"Recherche\" (en haut à gauche de l'écran). Il y a 6 panneaux de paramètres pouvant s'afficher.</p>" +
"<p>Le panneau \"Paramètres\" se divise en cinq sous-panneaux. Chaque sous-panneau se déploie en cliquant dans un des " +
"sous-titres de panneau. Cliquer à nouveau sur le titre cache le panneau. Cliquer sur \"Paramètres\" masque à nouveau " +
"tous les panneaux.</p>" +
"<ol>" +
"<li>Paramètres</li>" +
"<li>Ouverture et sauvegarde (accessible également en cliquant sur le nom du fichier en haut au milieu de " +
"la fenêtre)</li>" +
"<li>Metadonnées</li>" +
"<li>Personnes</li>" +
"<li>Templates</li>" +
...
"<tr><td style='background: salmon; font-weight: bold;'>Panneau params (surligné en rouge)</td><td style='background: salmon; font-weight: bold;'>Sous-panneau metadata (surligné en rouge)</td></tr>" +
