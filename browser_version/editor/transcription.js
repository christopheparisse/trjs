...
return {
	clickMS: function(e, l) { clickMS(e, l); },
	codeTier: function(p) { return codeTier(p); },
	convertFromTxtToCsv: function(p) { return convertFromTxtToCsv(p); },
	copyMultipleSelection: function() { copyMultipleSelection(); },
	createDivEditField: function(p1, p2) { return createDivEditField(p1, p2); },
	cutMultipleSelection: function() { cutMultipleSelection(); },
	deselectAllMS: function(e) { deselectAllMS(e); },
	doShiftTimeLinks: function() { doShiftTimeLinks(); },
	exportMStoCsv: function() { exportMStoCsv(); },
	exportMStoMedia: function() { exportMStoMedia(); },
	exportMStoMediaSubt: function(p) { exportMStoMediaSubt(p); },
	exportMStoSubt: function(p1, p2) { exportMStoSubt(p1, p2); },
	exportMStoSubtSrt: function(p) { exportMStoSubt('srt', p); },
	exportMStoSubtAss: function(p) { exportMStoSubt('ass', p); },
	exportMStoTei: function() { exportMStoTei(); },
	findCode: function(p) { return findCode(p); },
	formatTime: function(p) { return formatTime(p); },
	getCode: function(p) { return getCode(p); },
	getLine: function(p) { return getLine(p); },
	setType: function(p1, p2) { setType(p1, p2); },
	initialLoadFinished: function() { return initialLoadFlag; },
	isEmptyRow: function(p) { return isEmptyRow(p); },
	isnotbl: function(p) { return isnotbl(p); },
	loadCsvIntoGrid: function(p1, p2) { return loadCsvIntoGrid(p1, p2); },
	loadIntoGrid: function(p1, p2) { return loadIntoGrid(p1, p2); },
	loadNewGrid: function() { loadNewGrid(); },
	nbMissingDiv: function(p1, p2) { return nbMissingDiv(p1, p2); },
	pasteMultipleSelection: function() { pasteMultipleSelection(); },
	print: function(range) { trjs.utils.printByID('transcript'); },
	readCsv: function(p) { return readCsv(p); },
	saveTranscriptToCsvString: function() { return saveTranscriptToCsvString(); },
	saveTranscriptToString: saveTranscriptToString,
	saveTranscriptToText: function(p1,p2,p3) { return saveTranscriptToText(p1,p2,p3); },
	saveTranscriptToRtf: function(p1,p2,p3,p4) { return saveTranscriptToRtf(p1,p2,p3,p4); },
	saveTranscriptToHtml: saveTranscriptToHtml,
	selectAllMS: selectAllMS,
	setCode: function(p1, p2) { setCode(p1, p2); },
	setMultipleSelection: function() { return setMultipleSelection(); },
	...
	trUpdateCSS: function(p, q) { trUpdateCSS(p, q); },
	typeTier: function(p) { return typeTier(p); },
	updateCSS: function(p) { updateCSS(p); },
	updateLocNames: function() { updateLocNames(); },
	updateTimecode: function() { updateTimecode(); },
	xmlEntitiesEncode: function(p) { return xmlEntitiesEncode(p); },
};
})();
