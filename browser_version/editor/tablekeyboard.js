...
trjs.bindings.push( [49, true, false, false, false, trjs.events.setNthLoc1, trjs.messgs.bin49 ] ); // Ctrl 1
trjs.bindings.push( [50, true, false, false, false, trjs.events.setNthLoc2, trjs.messgs.bin50 ] ); // Ctrl 2
trjs.bindings.push( [51, true, false, false, false, trjs.events.setNthLoc3, trjs.messgs.bin51 ] ); // Ctrl 3
trjs.bindings.push( [52, true, false, false, false, trjs.events.setNthLoc4, trjs.messgs.bin52 ] ); // Ctrl 4
trjs.bindings.push( [53, true, false, false, false, trjs.events.setNthLoc5, trjs.messgs.bin53 ] ); // Ctrl 5
trjs.bindings.push( [54, true, false, false, false, trjs.events.setNthLoc6, trjs.messgs.bin54 ] ); // Ctrl 6
trjs.bindings.push( [55, true, false, false, false, trjs.events.setNthLoc7, trjs.messgs.bin55 ] ); // Ctrl 7
trjs.bindings.push( [56, true, false, false, false, trjs.events.setNthLoc8, trjs.messgs.bin56 ] ); // Ctrl 8
trjs.bindings.push( [57, true, false, false, false, trjs.events.setNthLoc9, trjs.messgs.bin57 ] ); // Ctrl 9

trjs.bindings.push( [35, true, false, false, false, trjs.events.ctrlEnd, trjs.messgs.bin35 ] ); // Ctrl End
trjs.bindings.push( [36, true, false, false, false, trjs.events.ctrlHome, trjs.messgs.bin36 ] ); // Ctrl Home
trjs.bindings.push( [66, true, false, false, false, trjs.media.playSlower, trjs.messgs.bin66 ] ); // Ctrl B
trjs.bindings.push( [68, true, false, false, false, trjs.events.deleteLineAndRedraw, trjs.messgs.bin68 ] ); // Ctrl D
trjs.bindings.push( [69, true, false, false, false, trjs.media.playFaster, trjs.messgs.bin69 ] ); // Ctrl E
trjs.bindings.push( [71, true, false, false, false, trjs.events.setDivPlusInsert, trjs.messgs.bin71 ] ); // Ctrl G
trjs.bindings.push( [73, true, false, false, false, trjs.events.insertBlankLineAndRedraw, trjs.messgs.bin73 ] ); // Ctrl I
trjs.bindings.push( [74, true, false, false, false, trjs.events.joinLine, trjs.messgs.bin74 ] ); // Ctrl J
trjs.bindings.push( [76, true, false, false, false, trjs.editor.showLine, trjs.messgs.bin76 ] ); // Ctrl L
trjs.bindings.push( [77, true, false, false, false, trjs.events.setTimeReplaceLocAndRedraw, trjs.messgs.bin77 ] ); // Ctrl M
trjs.bindings.push( [79, true, false, false, false, trjs.editor.openTranscript, trjs.messgs.bin79 ] ); // Ctrl O
trjs.bindings.push( [82, true, false, false, false, trjs.events.replicateLineAndRedraw, trjs.messgs.bin82 ] ); // Ctrl R
trjs.bindings.push( [83, true, false, false, false, trjs.editor.save, trjs.messgs.bin83 ] ); // Ctrl S
trjs.bindings.push( [84, true, false, false, false, trjs.editor.showTime, trjs.messgs.bin84 ] ); // Ctrl T
trjs.bindings.push( [85, true, false, false, false, trjs.editor.hideDiv, trjs.messgs.bin85 ] ); // Ctrl U
// trjs.bindings.push( [88, true, false, false, false, trjs.events.insertBlankLineLocAndRedraw, "" ] ); // Ctrl X
trjs.bindings.push( [89, true, false, false, false, trjs.undo.redo, trjs.messgs.bin89 ] ); // Ctrl Y
trjs.bindings.push( [90, true, false, false, false, trjs.undo.undo, trjs.messgs.bin90 ] ); // Ctrl Z

trjs.bindings.push( [49, true, false, true, false, trjs.events.setDivPlus, trjs.messgs.bin49 ] ); // Ctrl Shift 1
trjs.bindings.push( [50, true, false, true, false, trjs.events.setDivMinus, trjs.messgs.bin50 ] ); // Ctrl Shift 2
trjs.bindings.push( [71, true, false, true, false, trjs.events.setDivMissingMinus, trjs.messgs.bin71 ] ); // Ctrl Shift G

trjs.bindings.push( [49, true, false, true, false, trjs.events.setNthTier1, trjs.messgs.bin49 ] ); // Ctrl Shift 1
trjs.bindings.push( [50, true, false, true, false, trjs.events.setNthTier2, trjs.messgs.bin50 ] ); // Ctrl Shift 2
trjs.bindings.push( [51, true, false, true, false, trjs.events.setNthTier3, trjs.messgs.bin51 ] ); // Ctrl Shift 3
trjs.bindings.push( [52, true, false, true, false, trjs.events.setNthTier4, trjs.messgs.bin52 ] ); // Ctrl Shift 4
trjs.bindings.push( [53, true, false, true, false, trjs.events.setNthTier5, trjs.messgs.bin53 ] ); // Ctrl Shift 5
trjs.bindings.push( [54, true, false, true, false, trjs.events.setNthTier6, trjs.messgs.bin54 ] ); // Ctrl Shift 6
trjs.bindings.push( [55, true, false, true, false, trjs.events.setNthTier7, trjs.messgs.bin55 ] ); // Ctrl Shift 7
trjs.bindings.push( [56, true, false, true, false, trjs.events.setNthTier8, trjs.messgs.bin56 ] ); // Ctrl Shift 8
trjs.bindings.push( [57, true, false, true, false, trjs.events.setNthTier9, trjs.messgs.bin57 ] ); // Ctrl Shift 9

trjs.bindings.push( [65, true, true, false, false, trjs.transcription.selectAllMS, trjs.messgs.bin65 ] ); // Ctrl Alt A
trjs.bindings.push( [66, true, true, false, false, trjs.media.playReverse, trjs.messgs.bin66 ] ); // Ctrl Alt B
trjs.bindings.push( [68, true, true, false, false, trjs.events.deleteLineLocAndRedraw, trjs.messgs.bin68 ] ); // Ctrl Alt D
trjs.bindings.push( [69, true, true, false, false, trjs.media.playNormal, trjs.messgs.bin69 ] ); // Ctrl Alt E
trjs.bindings.push( [70, true, true, false, false, trjs.editor.showSearch, trjs.messgs.bin70 ] ); // Ctrl Alt F
trjs.bindings.push( [71, true, true, false, false, trjs.events.setDivMinusInsert, trjs.messgs.bin71 ] ); // Ctrl Alt G
trjs.bindings.push( [73, true, true, false, false, trjs.events.insertWithTimeAndRedraw, trjs.messgs.bin73 ] ); // Ctrl Alt I
if (trjs.utils.isWindows()) {
	trjs.bindings.push( [72, true, true, false, false, trjs.events.joinLineLoc, trjs.messgs.bin74 ] ); // Ctrl Alt H
} else {
	trjs.bindings.push( [74, true, true, false, false, trjs.events.joinLineLoc, trjs.messgs.bin74 ] ); // Ctrl Alt J
}
trjs.bindings.push( [77, true, true, false, false, trjs.events.setTimeReplaceAndRedraw, trjs.messgs.bin77 ] ); // Ctrl Alt M
trjs.bindings.push( [79, true, true, false, false, trjs.editor.openMedia, trjs.messgs.bin79 ] ); // Ctrl Alt O
trjs.bindings.push( [82, true, true, false, false, trjs.events.splitLineAndRedraw, trjs.messgs.bin82 ] ); // Ctrl Alt R
trjs.bindings.push( [85, true, true, false, false, trjs.editor.showDiv, trjs.messgs.bin85 ] ); // Ctrl Alt U

/*
trjs.bindings.push( [113, true, true, false, false, trjs.keys.colorRed, trjs.messgs.bin113 ] ); // Ctrl Alt F2
trjs.bindings.push( [114, true, true, false, false, trjs.keys.colorGreen, trjs.messgs.bin114 ] ); // Ctrl Alt F3
trjs.bindings.push( [115, true, true, false, false, trjs.keys.colorBlue, trjs.messgs.bin115 ] ); // Ctrl Alt F4
trjs.bindings.push( [116, true, true, false, false, trjs.keys.bold, trjs.messgs.bin116 ] ); // Ctrl Alt F5
trjs.bindings.push( [117, true, true, false, false, trjs.keys.italics, trjs.messgs.bin117 ] ); // Ctrl Alt F6
trjs.bindings.push( [118, true, true, false, false, trjs.keys.emphasis, trjs.messgs.bin118 ] ); // Ctrl Alt F7
*/
trjs.bindings.push( [119, true, true, false, false, trjs.transcription.setMultipleSelection, trjs.messgs.bin119 ] ); // Ctrl Alt F8
trjs.bindings.push( [120, true, true, false, false, trjs.transcription.exportMStoSubtSrt, trjs.messgs.bin120 ] ); // Ctrl Alt F9
trjs.bindings.push( [121, true, true, false, false, trjs.transcription.exportMStoSubtAss, trjs.messgs.bin121 ] ); // Ctrl Alt F10
trjs.bindings.push( [122, true, true, false, false, trjs.transcription.exportMStoMediaSubt, trjs.messgs.bin122 ] ); // Ctrl Alt F11
trjs.bindings.push( [123, true, true, false, false, trjs.transcription.exportMStoMedia, trjs.messgs.bin123 ] ); // Ctrl Alt F12

trjs.bindings.push( [37, false, true, false, false, trjs.media.backwardStep, trjs.messgs.bin37 ] ); // Alt Left
trjs.bindings.push( [38, false, true, false, false, trjs.events.keyLocUp, trjs.messgs.bin38 ] ); // Alt Up
trjs.bindings.push( [39, false, true, false, false, trjs.media.forwardStep, trjs.messgs.bin39 ] ); // Alt Right
trjs.bindings.push( [40, false, true, false, false, trjs.events.keyLocDown, trjs.messgs.bin40 ] ); // Alt Down
trjs.bindings.push( [112, false, true, false, false, trjs.media.playCurrent, trjs.messgs.bin112 ] ); // Alt F1
trjs.bindings.push( [113, false, true, false, false, trjs.media.makeSmall, trjs.messgs.bin113 ] ); // Alt F2
trjs.bindings.push( [114, false, true, false, false, trjs.media.makeBig, trjs.messgs.bin114 ] ); // Alt F3
trjs.bindings.push( [115, false, true, false, false, trjs.media.playSlower, trjs.messgs.bin115 ] ); // Alt F4
trjs.bindings.push( [116, false, true, false, false, trjs.media.playFaster, trjs.messgs.bin116 ] ); // Alt F5
trjs.bindings.push( [117, false, true, false, false, trjs.events.insertWithTimeLocAndRedraw, trjs.messgs.bin117 ] ); // Alt F6
trjs.bindings.push( [118, false, true, false, false, trjs.events.runThreeLines, trjs.messgs.bin118 ] ); // Alt F7
...
trjs.bindings.push( [9, false, false, true, false, trjs.events.shiftTab, trjs.messgs.bin9 ] ); // Shift Tab
trjs.bindings.push( [112, false, false, true, false, trjs.media.playPause, trjs.messgs.bin112 ] ); // Shift F1

/*
trjs.keys.special1 = function() { console.timeEnd("page"); };
trjs.bindings.push( [114, false, false, true, false, trjs.keys.special1, trjs.messgs.bin114 ] ); // Shift F3
*/
trjs.bindings.push( [115, false, false, true, false, trjs.io.htmlSave, trjs.messgs.bin115 ] ); // Shift F4
};

trjs.keys.initApiBindings = function() {
	/* clé - ctrl alt shift meta function description */
trjs.bindings.push( [48, false, true, false, false, function() { trjs.api.key(9); }, trjs.api.desc(9) ] ); // Alt 0 et Alt @
trjs.bindings.push( [50, false, true, false, false, function() { trjs.api.key(6); }, trjs.api.desc(6) ] ); // Alt 2
trjs.bindings.push( [57, false, true, false, false, function() { trjs.api.key(7); }, trjs.api.desc(7) ] ); // Alt 9
trjs.bindings.push( [58, false, true, false, false, function() { trjs.api.key(73); }, trjs.api.desc(73) ] ); // Alt :
trjs.bindings.push( [65, false, true, false, false, function() { trjs.api.key(19); }, trjs.api.desc(19) ] ); // Alt A
trjs.bindings.push( [68, false, true, false, false, function() { trjs.api.key(43); }, trjs.api.desc(43) ] ); // Alt D
trjs.bindings.push( [69, false, true, false, false, function() { trjs.api.key(3); }, trjs.api.desc(3) ] ); // Alt E
trjs.bindings.push( [72, false, true, false, false, function() { trjs.api.key(71); }, trjs.api.desc(71) ] ); // Alt H
trjs.bindings.push( [73, false, true, false, false, function() { trjs.api.key(1); }, trjs.api.desc(1) ] ); // Alt I
trjs.bindings.push( [74, false, true, false, false, function() { trjs.api.key(60); }, trjs.api.desc(60) ] ); // Alt J
trjs.bindings.push( [78, false, true, false, false, function() { trjs.api.key(61); }, trjs.api.desc(61) ] ); // Alt N
trjs.bindings.push( [79, false, true, false, false, function() { trjs.api.key(23); }, trjs.api.desc(23) ] ); // Alt O
trjs.bindings.push( [81, false, true, false, false, function() { trjs.api.key(24); }, trjs.api.desc(24) ] ); // Alt Q
trjs.bindings.push( [82, false, true, false, false, function() { trjs.api.key(68); }, trjs.api.desc(68) ] ); // Alt R
trjs.bindings.push( [83, false, true, false, false, function() { trjs.api.key(46); }, trjs.api.desc(46) ] ); // Alt S
trjs.bindings.push( [84, false, true, false, false, function() { trjs.api.key(42); }, trjs.api.desc(42) ] ); // Alt T
trjs.bindings.push( [85, false, true, false, false, function() { trjs.api.key(21); }, trjs.api.desc(21) ] ); // Alt U
trjs.bindings.push( [86, false, true, false, false, function() { trjs.api.key(18); }, trjs.api.desc(18) ] ); // Alt V
trjs.bindings.push( [88, false, true, false, false, function() { trjs.api.key(51); }, trjs.api.desc(51) ] ); // Alt X
trjs.bindings.push( [90, false, true, false, false, function() { trjs.api.key(47); }, trjs.api.desc(47) ] ); // Alt Z
trjs.bindings.push( [78, false, true, true, false, function() { trjs.api.key(74); }, trjs.api.desc(74) ] ); // Alt Shift N
...
trjs.keys.initMacrosBindings = function() {
	/* clé - ctrl alt shift meta function description */
	trjs.bindings.push( [48, true, true, true, false, function() { trjs.macros.key(0); }, trjs.macros.desc(0) ] ); // ctrl+alt+shift 0
};
