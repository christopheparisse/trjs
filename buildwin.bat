...
cmd /c electron-packager app --platform=win32 --asar --arch=x64 --overwrite --icon=app\style\trjs.ico
...
cmd /c electron-packager app --platform=win32 --asar --arch=ia32 --overwrite --icon=app\style\trjs.ico
