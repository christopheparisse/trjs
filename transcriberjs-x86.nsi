...
Name "trjs-install-v0.7.4a-x86"

; The file to write
OutFile "trjs-v0.7.4a-x86.exe"
...
Section "trjs 64bits v0.7.4a (required)"

  SectionIn RO

  ; Put file there
  SetOutPath $INSTDIR
  File /r "C:\devlopt\builds\trjs-x86\Trjs-win32-ia32\*.*"
