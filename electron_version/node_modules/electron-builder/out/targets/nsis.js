...
class NsisTarget extends (_targetFactory || _load_targetFactory()).Target {
    ...
    doBuild(appOutDir, arch) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            return yield (0, (_archive || _load_archive()).archive)(packager.devMetadata.build.compression, "7z", archiveFile, appOutDir, true);
        })();
    }
    finishBuild() {
        var _this2 = this;
    ...
    buildInstaller() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            const iconPath = (yield packager.getResource(_this3.options.installerIcon, "installerIcon.ico")) || (yield packager.getIconPath());
            ...
            const installerHeader = oneClick ? null : yield packager.getResource(_this3.options.installerHeader, "installerHeader.bmp");
            if (installerHeader != null) {
                defines.MUI_HEADERIMAGE = null;
                defines.MUI_HEADERIMAGE_RIGHT = null;
                defines.MUI_HEADERIMAGE_BITMAP = installerHeader;
            }
            const installerHeaderIcon = oneClick ? yield packager.getResource(_this3.options.installerHeaderIcon, "installerHeaderIcon.ico") : null;
            ...
            const licenseFile = yield packager.getResource(_this3.options.license, "license.rtf", "license.txt");
            if (licenseFile != null) {
                defines.LICENSE_FILE = licenseFile;
            }
            const customScriptPath = yield packager.getResource(_this3.options.script, "installer.nsi");
