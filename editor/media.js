...
//              trjs.editor.openMedia();
    ...
    return {
        ...
        backwardStep: function (e) {
            backwardStep(e);
        },
        changeToBig: function (e) {
            changeToBig(e);
        },
        changeToMedium: function (e) {
            changeToMedium(e);
        },
        changeToDefault: function (e) {
            changeToDefault(e);
        },
        changeToStandard: function (e) {
            changeToStandard(e);
        },
        changeToSmall: function (e) {
            changeToSmall(e);
        },
        display: function (p) {
            display(p);
        },
        endContinuousPlay: function (e) {
            endContinuousPlay(e);
        },
        forwardStep: function (e) {
            forwardStep(e);
        },
        getTime: function () {
            return getTime();
        ...
        */
        ...
        playStartLine: function (e) {
            playStartLine(e);
        },
        runContinuous: function (s, c) {
            runContinuous(s, c);
        },
        runFromTo: function (s, e, p1, p2, p3) {
            runFromTo(s, e, p1, p2, p3);
        },
